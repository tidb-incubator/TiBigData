...
import static io.tidb.bigdata.prestodb.tidb.TiDBConfig.PRIMARY_KEY;
import static io.tidb.bigdata.prestodb.tidb.TiDBConfig.UNIQUE_KEY;
import static io.tidb.bigdata.prestodb.tidb.TypeHelpers.getHelper;
    ...
    ConnectorTableLayout layout =
        new ConnectorTableLayout(
            new TiDBTableLayoutHandle(
                tableHandle, Optional.of(constraint.getSummary()), Optional.empty()));
  ...
  private ConnectorTableMetadata getTableMetadata(String schemaName, String tableName) {
    return new ConnectorTableMetadata(
        ...
        ImmutableMap.of(
            ...
            UNIQUE_KEY, getInternal().getUniqueKeyColumns(schemaName, tableName).stream()
