...
import com.zhihu.prestodb.tidb.TiDBColumnHandle;
...
import static com.zhihu.prestodb.tidb.optimization.TiDBPlanOptimizerProvider.isPushdownType;
        ...
        extends RowExpressionTranslator<Expression, Map<VariableReferenceExpression, ColumnHandle>>
{
    ...
    @Override
    public TranslatedExpression<Expression> translateConstant(ConstantExpression literal, Map<VariableReferenceExpression, ColumnHandle> context, RowExpressionTreeTranslator<Expression, Map<VariableReferenceExpression, ColumnHandle>> rowExpressionTreeTranslator)
    {
    ...
    @Override
    public TranslatedExpression<Expression> translateVariable(VariableReferenceExpression variable, Map<VariableReferenceExpression, ColumnHandle> context, RowExpressionTreeTranslator<Expression, Map<VariableReferenceExpression, ColumnHandle>> rowExpressionTreeTranslator)
    {
    ...
    @Override
    public TranslatedExpression<Expression> translateLambda(LambdaDefinitionExpression lambda, Map<VariableReferenceExpression, ColumnHandle> context, RowExpressionTreeTranslator<Expression, Map<VariableReferenceExpression, ColumnHandle>> rowExpressionTreeTranslator)
    {
        return untranslated(lambda);
    }

    @Override
    public TranslatedExpression<Expression> translateCall(CallExpression call, Map<VariableReferenceExpression, ColumnHandle> context, RowExpressionTreeTranslator<Expression, Map<VariableReferenceExpression, ColumnHandle>> rowExpressionTreeTranslator)
    {
    ...
    @Override
    public TranslatedExpression<Expression> translateSpecialForm(SpecialFormExpression specialForm, Map<VariableReferenceExpression, ColumnHandle> context, RowExpressionTreeTranslator<Expression, Map<VariableReferenceExpression, ColumnHandle>> rowExpressionTreeTranslator)
    {
        List<TranslatedExpression<Expression>> translatedExpressions = specialForm.getArguments().stream()
                .map(expression -> rowExpressionTreeTranslator.rewrite(expression, context))
                .collect(toImmutableList());
