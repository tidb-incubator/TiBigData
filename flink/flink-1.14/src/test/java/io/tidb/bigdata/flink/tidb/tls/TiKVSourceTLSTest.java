...
public class TiKVSourceTLSTest {
  ...
  public void testTLS() {
    ...
    properties.put(CLUSTER_TLS_CA, "/config/cert/root.crt");
    properties.put(CLUSTER_TLS_CERT, "/config/cert/client.crt");
    properties.put(CLUSTER_TLS_KEY, "/config/cert/client-pkcs8.key");
  ...
  public void testJKS() {
    ...
    properties.put(CLUSTER_JKS_TRUST_PATH, "/config/cert/server-cert-store");
    properties.put(CLUSTER_JKS_TRUST_PASSWORD, "12345678");
    properties.put(CLUSTER_JKS_KEY_PATH, "/config/cert/client-keystore.p12");
