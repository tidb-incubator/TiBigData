...
public class FilterPushDownNotEqualTest extends FilterPushDownTestBase {
  ...
  public void testSupportedFilter() {
    ...
    Expression expression =
        Expressions.notEqual(Expressions.column(column, type), Expressions.constant(value, type));
    ...
    value = 2;
    expression =
        Expressions.notEqual(Expressions.constant(value, type), Expressions.column(column, type));
