...
public class FilterPushDownLessThanTest extends FilterPushDownTestBase {
  ...
  public void testSupportedFilter() {
    ...
    Expression expression =
        Expressions.lessThan(Expressions.column(column, type), Expressions.constant(value, type));
    ...
    value = 0;
    expression =
        Expressions.lessThan(Expressions.constant(value, type), Expressions.column(column, type));
