...
public class TiDBSchemaAdapter implements Serializable {
  ...
  public TiDBSchemaAdapter(ResolvedCatalogTable table) {
    ...
    this.metadata = parserMetadataColumns(properties);
  ...
  private Object[] setMetadata(final TiTimestamp timestamp) {
  ...
  public GenericRowData convert(final TiTimestamp timestamp, RecordCursorInternal cursor) {
    Object[] objects = setMetadata(timestamp);
  ...
  public static LinkedHashMap<String, TiDBMetadata> parserMetadataColumns(
