...
| tidb.stored-rows-in-memory                  | false                                                                          | Whether to cache data in memory for each region. This helps improve the success rate when reading data, but takes up more memory(100-200m).                                                                                                                                                                                                                                                                                                               |
