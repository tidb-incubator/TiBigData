...
| tidb.sink.impl                                      | JDBC                                                                           | The value can be `JDBC` or `TIKV`. If you set this configuration to `TIKV`, flink will write data bypass TiDB. It is only available for version 1.14+.  It is only available for version 1.14+.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
