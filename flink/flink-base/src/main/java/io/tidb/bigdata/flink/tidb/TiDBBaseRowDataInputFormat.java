...
public abstract class TiDBBaseRowDataInputFormat extends RichInputFormat<RowData, InputSplit>
  ...
  public TiDBBaseRowDataInputFormat(
    ...
    timestamp =
        getOptionalVersion().orElseGet(() -> getOptionalTimestamp().orElse(splitSnapshotVersion));
  }
  ...
  public void setProjectedFields(int[][] projectedFields) {
    ...
    for (int i = 0; i < projectedFields.length; i++) {
      ...
      Preconditions.checkArgument(
          projectedField != null && projectedField.length == 1,
