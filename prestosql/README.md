...
tar -zxf prestosql/target/prestosql-connector-0.0.3-SNAPSHOT-plugin.tar.gz -C prestosql/target
cp -r prestosql/target/prestosql-connector-0.0.3-SNAPSHOT/tidb ${PRESTO_HOME}/plugin
