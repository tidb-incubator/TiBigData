...
import com.zhihu.presto.tidb.DataTypes;
...
import static com.zhihu.prestosql.tidb.TypeHelper.RecordCursorReader;
import static java.util.Objects.requireNonNull;

public final class TiDBColumnHandle
        implements ColumnHandle
{
    ...
    {
        this(requireNonNull(name, "name is null"), requireNonNull(type, "type is null"), DataTypes.deserialize(type), ordinalPosition);
    }
    ...
    {
        this(requireNonNull(handle, "handle is null").getName(), DataTypes.serialize(handle.getType()), handle.getType(), handle.getOrdinalPosition());
    }
