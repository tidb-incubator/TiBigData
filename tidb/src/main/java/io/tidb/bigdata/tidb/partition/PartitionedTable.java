...
package io.tidb.bigdata.tidb.partition;

import static io.tidb.bigdata.tidb.expression.FuncCallExpr.Type.YEAR;

import io.tidb.bigdata.tidb.expression.*;
import io.tidb.bigdata.tidb.expression.visitor.RangePartitionLocator;
...
public class PartitionedTable implements Serializable {
  ...
  private PartitionedTable(
      TableCommon logicalTable,
      TableCommon[] physicalTables,
  ...
  public static PartitionedTable newPartitionTable(TiTableInfo tableInfo) {
    TableCommon logicalTable = new TableCommon(tableInfo.getId(), tableInfo.getId(), tableInfo);
