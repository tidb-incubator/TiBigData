...
import static io.tidb.bigdata.tidb.expression.ArithmeticBinaryExpression.Type.BIT_AND;
import static io.tidb.bigdata.tidb.expression.ArithmeticBinaryExpression.Type.BIT_OR;
import static io.tidb.bigdata.tidb.expression.ArithmeticBinaryExpression.Type.BIT_XOR;
import static io.tidb.bigdata.tidb.expression.ArithmeticBinaryExpression.Type.DIVIDE;
import static io.tidb.bigdata.tidb.expression.ArithmeticBinaryExpression.Type.MINUS;
import static io.tidb.bigdata.tidb.expression.ArithmeticBinaryExpression.Type.MULTIPLY;
import static io.tidb.bigdata.tidb.expression.ArithmeticBinaryExpression.Type.PLUS;
