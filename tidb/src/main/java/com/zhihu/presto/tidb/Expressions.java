...
{
    private final static Expression CONSTANT_0 = new Constant(0, TINYINT);
    private final static Expression CONSTANT_1 = new Constant(1, TINYINT);

    private final static Expression ALWAYS_FALSE = equal(CONSTANT_0, CONSTANT_1);
    private final static Expression ALWAYS_TRUE = equal(CONSTANT_1, CONSTANT_1);
